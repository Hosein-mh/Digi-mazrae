...
export default function Dashbord() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 56 53">
      <g id="dashbord_Logo" data-name="dashbord Logo" transform="translate(3 3)">
        <g id="Rectangle_1" data-name="Rectangle 1" fill="none" stroke="#0d0d0d" strokeLinecap="round" strokeWidth="3">
        ...
        <path id="Path_2" data-name="Path 2" d="M81,267l6.667-8.167,6.167,3.5,6.667-9.667-3.333,1" transform="translate(-78 -249)" fill="none" stroke="#6fa12e" strokeWidth="1"/>
        <path id="Path_3" data-name="Path 3" d="M100.5,255.833l.833-3.667" transform="translate(-78 -249)" fill="none" stroke="#6fa12e" strokeWidth="1"/>
        ...
        <path id="Path_4" data-name="Path 4" d="M121.5,273.833l-5.5-6.667V256s10,4.167,8.667,11.167S121.5,273.833,121.5,273.833Z" transform="translate(-78 -249)" fill="#7874fc" stroke="#fff" strokeWidth="1"/>
        <path id="Path_5" data-name="Path 5" d="M116,257.167s3.833.667,5.333,2.667a13.1,13.1,0,0,1,2,3.667L116,267.333Z" transform="translate(-78 -248.896)" fill="#f9ab44" stroke="#fff" strokeWidth="1"/>
      </g>
    </svg>
  )
}
